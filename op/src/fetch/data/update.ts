 ...
 * @LastEditTime: 2020-05-18 17:10:47
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /@ownpack/op/src/fetch/data/update.ts
 */ 
...
function fetchUpdate(table: string | number, id: string, params: {
  ...
  return new Promise((resolve, reject)=>{
    ...
    BaaS_F.put(`https://cloud.minapp.com/userve/v2.4/table/${table}/record/${id}/`, updata).then((res: any) => {
      resolve(res)
    }).catch((err: any) => {
      reject(err)
    })
