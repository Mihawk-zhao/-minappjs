...
import { PLATFORM_ERROR, FIND_R_ERROR, FIND_CHECKR_ERROR, FIND_P_ERROR, } from '../../constants/error'
...
function fetchFindUser(params: {
  ...
  if(ArgsObj.Platform === PLATFORM_NAME.WEBAPI){
    return new Promise((resolve, reject)=>{
      ...
      BaaS_F({
        method: 'get',
        url: `${ArgsObj.RequestBase}/hserve/v2.2/user/info/`,
...
function initFetchFindUser(args: ['webapi', {clientID?: string, host?: string, accessToken?: string, env?: string}]){
